...
func (api *API) routes() {
	...
	suggestTestCasesV1 := router.Group("v1/suggest-test-cases", authenticationMiddleware)
	{
		suggestTestCasesV1.Post("/document", apiv1.UploadDocument(api.SuggestedTestCaseService, api.logger))
	}
